	...
	public class HapticAudio_main : MonoBehaviour
	{
		...
		public void RestoreFromXmlConfig()
		{
			...
			if (!useDefaultDevConfig)
			{
				path = EditorUtility.OpenFilePanel(
				 ...
				 Application.dataPath + "C:/Users/meteor/Documents/dreamscape-framework/unity-template/Assets/DreamscapeCommon/Haptic_DMX/",
				 "xml");
			}
#endif
            if (path.Length != 0)
		...
		private string GetRuntimeDmxConfigPath()
		{
			...
			else
			{
				...
				return Path.Combine(Application.dataPath, "C:/Users/meteor/Documents/dreamscape-framework/unity-template/Assets/DreamscapeCommon/Haptic_DMX");
			}
		}

		public void SaveToXmlConfig()
		{
			var path = Path.Combine(Application.dataPath, "C:/Users/meteor/Documents/dreamscape-framework/unity-template/Assets/DreamscapeCommon/Haptic_DMX");
#if UNITY_EDITOR
			if (!useDefaultDevConfig)
			{
