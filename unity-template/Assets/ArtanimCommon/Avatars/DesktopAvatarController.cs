...
namespace Artanim
{
    ...
    public class DesktopAvatarController : MonoBehaviour
    {
        ...
        public Transform TrackingHandLeft;
        public Transform TrackingHandRight;
        ...
        private void Start()
        {
            ...
            //Init VR
            //XRUtils.Instance.IsDevicePresent
        ...
        private void LateUpdate()
        {
            if (XRSettings.enabled)
            {
                if (MainCameraController.Instance && MainCameraController.Instance.HeadRigidBody && AvatarRoot)
                {
                    ...
                    //Update hands
                    UpdateHand(EAvatarBodyPart.LeftHand, TrackingHandLeft, XRNode.LeftHand);
                    UpdateHand(EAvatarBodyPart.RightHand, TrackingHandRight, XRNode.RightHand);
        ...
        private void UpdateHead(Transform headTransform)
        {
            if (headTransform)
            {
                ...
                //Update avatar head
                var avatarHeadTransform = AvatarController.AvatarAnimator.GetBoneTransform(HumanBodyBones.Head);
                if (avatarHeadTransform)
                {
                    avatarHeadTransform.position = headTransform.position;
                    avatarHeadTransform.rotation = headTransform.rotation;
                }
            }
        }
        ...
        private void UpdateHand(EAvatarBodyPart bodyPart, Transform handTransform, XRNode node)
        {
            //Update bodypart
