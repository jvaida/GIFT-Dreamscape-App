...
#if UNITY_STANDALONE_WIN
				File.Copy(Artanim.ArtanimCommon.EditorCommonDir + divider + "TeamSpeak" + divider + "soundbackends" + divider + "directsound_win32.dll",buildDataDir + "TeamSpeak" + divider + "soundbackends" + divider + "directsound_win32.dll");
				File.Copy(Artanim.ArtanimCommon.EditorCommonDir + divider + "TeamSpeak" + divider + "soundbackends" + divider + "directsound_win64.dll",buildDataDir + "TeamSpeak" + divider + "soundbackends" + divider + "directsound_win64.dll");
				File.Copy(Artanim.ArtanimCommon.EditorCommonDir + divider + "TeamSpeak" + divider + "soundbackends" + divider + "windowsaudiosession_win32.dll",buildDataDir + "TeamSpeak" + divider + "soundbackends" + divider + "windowsaudiosession_win32.dll");
				File.Copy(Artanim.ArtanimCommon.EditorCommonDir + divider + "TeamSpeak" + divider + "soundbackends" + divider + "windowsaudiosession_win64.dll",buildDataDir + "TeamSpeak" + divider + "soundbackends" + divider + "windowsaudiosession_win64.dll");
#elif UNITY_STANDALONE_OSX
